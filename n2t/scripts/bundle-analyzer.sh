...
# Execute this script from the n2t directory by executing 'source ./scripts/bundle-analyzer.sh'
...
npx esbuild ./src/n2t.ts \
    --bundle \
    --platform=node \
    --outfile=./bundle/JackAnalyzer.js \
    --banner:js="/**
 * Author: Philip Brown
 * Source: https://github.com/pwbrown/nand2tetris/src/n2t.ts
 *
 * In order to comply with the project10 requirements of not including
